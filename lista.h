...
// Pre: la lista fue creada
// Post: se agregó un nodo con el dato recibido al principio de la lista.  En caso que no se pueda insertar el elemento devuelve false.
bool lista_insertar_primero(lista_t* lista, void* dato);

// Agrega un elemento al final de la lista
// Pre: la lista fue creada
// Post: se agregó un nodo con el dato recibido al final de la lista. En caso que no se pueda insertar el elemento devuelve false.
